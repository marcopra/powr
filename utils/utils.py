...
def get_run_name(args, current_date= None):
    ...
    return str(current_date)+"_"+str(args.env)+"_"+str(args.algo)+"_t"+str(args.timesteps)+"_HiddenL"+str(args.hidden_layers) + (f"_activation-{args.activation}" if args.activation is not None else "") +"_seed"+str(args.seed)+"_"+socket.gethostname()
